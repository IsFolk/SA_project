...
public class HandInHelper {
    ...
    public JSONObject create(HandIn h) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `sa_project`.`question`(`HandInId`)"
                    + " VALUES(?)";
    ...
    public Question getById(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`handIn` WHERE `handIn`.`HandInId` = ? LIMIT 1";
            ...
            while(rs.next()) {
                ...
                HandIn h = new HandIn(handin_id, handInAns1, handInAns2, handInAns3, handInAns4, gotPoint);
            }
