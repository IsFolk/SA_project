...
public class ProfessorHelper {
     ...
     * 採用Singleton不需要透過new
     */
    private ProfessorHelper() {
        
    }
    
    /** 靜態變數，儲存MemberHelper物件 */
    private static ProfessorHelper ph;
     ...
     */
    public static ProfessorHelper getHelper() {
        /** Singleton檢查是否已經有MemberHelper物件，若無則new一個，若有則直接回傳 */
        if(ph == null) ph = new ProfessorHelper();
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                int courselistid = rs.getInt("CourseListId");
                
                /** 將每一筆會員資料產生一名新Member物件 */
                p = new Professor(id, email, password, name, department, position, courselistid);
     ...
     */
    public boolean checkDuplicate(Professor p){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `sa_project`.`professor` WHERE `Email` = ?";
