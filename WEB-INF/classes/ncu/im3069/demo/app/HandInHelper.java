...
public class HandInHelper {
    ...
    public JSONObject create(HandIn h) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `sa_project`.`handIn`(`HandInAnswer1`,`HandInAnswer2`,`HandInAnswer3`,`HandInAnswer4`)"
                    + "VALUES(?,?,?,?)";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                int handin_id = rs.getInt("HandInId");
                String handInAns1 = rs.getString("HandInAnswer1");
                String handInAns2 = rs.getString("HandInAnswer2");
                String handInAns3 = rs.getString("HandInAnswer3");
                String handInAns4 = rs.getString("HandInAnswer4");
                int gotPoint = rs.getInt("GotPoint");
