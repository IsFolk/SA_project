...
public class ManagerHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `sa_project`.`manager` WHERE `ManagerId` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`manager`";
    ...
    public boolean checkDuplicate(Manager m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `sa_project`.`manager` WHERE `ManagerEmail` = ?";
    ...
    public JSONObject create(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `sa_project`.`manager`(`ManagerName`, `ManagerEmail`, `Password`, `modified`, `created`, `login_times`)"
                    + " VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Manager m) {
        ...
        try {
            ...
            String sql = "Update `sa_project`.`manager` SET `ManagerName` = ? ,`Password` = ? , `modified` = ? WHERE `ManagerEmail` = ?";
            /** 取得所需之參數 */
            String name = m.getName();
            String email = m.getEmail();
            String password = m.getPassword();
    ...
    public void updateLoginTimes(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa_project`.`manager` SET `login_times` = ? WHERE `ManagerId` = ?";
            /** 取得會員編號 */
            int id = m.getID();
