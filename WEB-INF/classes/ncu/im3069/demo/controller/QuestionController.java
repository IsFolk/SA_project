...
public class QuestionController extends HttpServlet {
    ...
    private QuestionHelper qh =  QuestionHelper.getHelper();
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //int test_id = jso.getInt("TestId");
        String text = jso.getString("QuestionText");
        ...
        String answerA = jso.getString("CorrectAnswer1");
        String answerB = jso.getString("CorrectAnswer2");
        String answerC = jso.getString("CorrectAnswer3");
        String answerD = jso.getString("CorrectAnswer4");
        int givePoint = jso.getInt("GivePoint");
        
        /** 建立一個新的會員物件 */
        Question q = new Question(text, optionA, optionB, optionC, optionD, answerA, answerB, answerC, answerD, givePoint); 
        ...
        /** 透過MemberHelper物件的create()方法新建一個會員至資料庫 */
            JSONObject data = qh.create(q);
            
            /** 新建一個JSONObject用於將回傳之資料進行封裝 */
            JSONObject resp = new JSONObject();
            resp.put("status", "200");
            resp.put("message", "成功! 新增一個題目...");
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //String test_id = jsr.getParameter("TestId");
    	//int TestId = valueOf(test_id);

        
        /** 判斷該字串是否存在，若存在代表要取回個別會員之資料，否則代表要取回全部資料庫內會員之資料 */
        if (id.isEmpty()) {
            /** 透過MemberHelper物件之getAll()方法取回所有會員之資料，回傳之資料為JSONObject物件 */
            JSONObject query = qh.getAll();
           // JSONObject query = qh.getAll();
            ...
            JSONObject query = qh.getByID(id);
    ...
    private int valueOf(String test_id) {
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
       ...
       // int test_id = jso.getInt("TestId");
        ...
        Question q = new Question(id, text, optionA, optionB, optionC, optionD, answerA, answerB, answerC, answerD, givePoint);
