...
public class HandInHwHelper {
    
    /**
     * 實例化（Instantiates）一個新的（new）MemberHelper物件<br>
     * 採用Singleton不需要透過new
     */
    private HandInHwHelper() {
        
    }
    
    /** 靜態變數，儲存MemberHelper物件 */
    private static HandInHwHelper hih;
     ...
     */
    public static HandInHwHelper getHelper() {
        /** Singleton檢查是否已經有MemberHelper物件，若無則new一個，若有則直接回傳 */
        if(hih == null) hih = new HandInHwHelper();
