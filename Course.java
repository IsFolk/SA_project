...
public class Course {
   ...
   // private ProfessorList pfl;
     ...
     * 取得修課學生名單
     *
     * @return the StudentList 回傳修課學生名單
     */
 //   public int getSdListId() {
 //       return this.stl.id; //不確定到底要回傳啥??
 //   }
    
    /**
     * 取得授課老師名單
     *
     * @return the ProfessorList 回傳授課教授名單
     */
 //   public int getPfListId() {
 //       return this.pfl.id; //Same as the above 
 //   }    
